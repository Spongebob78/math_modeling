...
def animate(i):
    ...
    X2.append(ellips2(p1=2, e1=0.65, fi1=i)[0])
    Y1.append(ellips1(p=3, e=0.65, fi=i)[1])
    Y2.append(ellips2(p1=2, e1=0.65, fi1=i)[1])
    figur.set_data(ellips1(p=3, e=0.65, fi=i))
    trajectory.set_data(X1, Y1)
    figur1.set_data(ellips2(p1=2, e1=0.65, fi1=i))
